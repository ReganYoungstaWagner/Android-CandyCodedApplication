...
public class DetailActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {                                            //overriding the optionsItemSelected method
        createShareIntent();
        return super.onOptionsItemSelected(item);
    }

    private void createShareIntent() {                                                              //Creating the createShareIntent method
        ...
        startActivity(shareIntent);                                                                 //Starting the ShareIntentActivity
